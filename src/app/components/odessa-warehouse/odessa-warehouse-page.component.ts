...
@Component({
  selector: 'odessa-warehouse-app',
  templateUrl: './odessa-warehouse-page.component.html',
  styleUrls: ['./odessa-warehouse-page.component.css'],
})
export class OdessaWarehousePageComponent implements OnInit{
